...
Each testcase was then run on each algorithm and saved in a spreadsheet producing a csv table, refer to appendix\S.
...
\subsection{Raw Data}
Refer to the appendix for the \hypertarget{random100}{raw data} for the algorithms running on the six testgroups: 100, 1000, 10k randomized numbers respectively and 3 differently correlated datasets. 
...
\begin{table}[!h]\centering
    \caption{Randomized 100 items} \label{100-mean}
...
\begin{table}[!h]\centering
    \caption{Randomized 1000 items} \label{1000-mean}
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        \tabucline[1pt]{1-6} 
        Testcase & 1 & 2 & 3 & 4 & 5 \\ [-1pt] \tabucline[1pt]{1-6} 
...
\begin{table}[!h]\centering
    \caption{Randomized 10k items} \label{10k-mean}
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        \tabucline[1pt]{1-6} 
        Testcase & 1 & 2 & 3 & 4 & 5 \\ [-1pt] \tabucline[1pt]{1-6} 
...
\begin{table}[!h]\centering
    \caption{Uncorrelated Dataset} \label{uncorrelated-mean}
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        \tabucline[1pt]{1-6} 
        Testcase & 1 & 2 & 3 & 4 & 5 \\ [-1pt] \tabucline[1pt]{1-6} 
...
\begin{table}[!h]\centering
    \caption{Weakly Correlated Dataset} \label{weakly-mean}
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        \tabucline[1pt]{1-6} 
        Testcase & 1 & 2 & 3 & 4 & 5 \\ [-1pt] \tabucline[1pt]{1-6} 
...
\begin{table}[!h]\centering
    \caption{Strongly Correlated Dataset} \label{strongly-mean}
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        \tabucline[1pt]{1-6} 
        Testcase & 1 & 2 & 3 & 4 & 5 \\ [-1pt] \tabucline[1pt]{1-6} 
...
\begin{table}[!h]\centering
    ...
    \begin{tabu}{|c|c|c|c|c|c|c|}
        ...
        \multirow{6}{*}{Harmony} & 4163 & 2561 & 5254 & 3535 & 1747 \\ \cline{2-6}
...
\begin{table}[!h] \centering
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        Testcase & 1 & 2 & 3 & 4 & 5 \\ [-1pt] \tabucline[1pt]{1-6} 
        Optimal & 4169 & 2561 & 5309 & 3535 & 1747 \\ [-1pt] \tabucline[1pt]{1-6} 
        \multirow{6}{*}{Harmony} & 156898 & 119888 & 141878 & 110608 & 128009 \\ \cline{2-6}
...
\begin{table}[!h] \centering
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        \multirow{6}{*}{Harmony} &7667918 &10556718 &8064941 &9425334 &9545542 \\ \cline{2-6}
...
\begin{table}[!h] \centering
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        \multirow{6}{*}{Harmony} &9147 &11238 &51166 &100770 &450386 \\ \cline{2-6}
...
\begin{table}[!h] \centering
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        \multirow{6}{*}{Harmony} &1514 &1627 &8917 &17251 &82712 \\ \cline{2-6}
...
\begin{table}[!h] \centering
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        \tabucline[1pt]{1-6} 
        Testcase & 1 & 2 & 3 & 4 & 5 \\ [-1pt] \tabucline[1pt]{1-6} 
        Optimal &2697 &14390 &28919 &146919 \\ [-1pt] \tabucline[1pt]{1-6} 
        \multirow{6}{*}{Harmony} &2390 &2697 &13586 &26711 &126318 \\ \cline{2-6}
