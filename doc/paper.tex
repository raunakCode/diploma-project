...
\begin{enumerate}
    \item Create a harmony memory (HM - a fixed size of randomly generated harmonies), initialize parameters harmony memory consider rate (HMCR), and pitch adjusting rate (PAR).
