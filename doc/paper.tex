...
\begin{table}[h!]
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        Mean \% dev. from optimal &0.21\%  &0\%  &0.40\%  &0\%  &0\%  \\ [-1pt] \tabucline[1pt]{1-6}
        BMQHOA Mean &3926.83$\pm$40.27 &2561.00$\pm$0 &4879$\pm$46.18 &3360.66$\pm$68.96 &1711.5$\pm$25.71 \\[1em] \hline
        Mean \% dev. from optimal &5.80\% &0\%  &8.09\% &4.93\% &2.03\% \\ [-1pt] \tabucline[1pt]{1-6}
    \end{tabu}
\end{table}
...
\begin{table}
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        Mean \% dev. from optimal &13.71\% &11.76\% &14.12\% &10.77\% &13.27\% \\ [-1pt] \tabucline[1pt]{1-6}
        BMQHOA Mean &145086.5$\pm$1035.45 &109876.33$\pm$1540.63 &136622.66$\pm$2042.95 &101951.33$\pm$1271.88 &118291.16$\pm$799.78 \\ \hline
        Mean \% dev. from optimal &19.79\% &18.25\% &18.56\% &17.10\% &18.82\% \\ [-1pt] \tabucline[1pt]{1-6}
    \end{tabu}
\end{table}
...
\begin{table}
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        Mean \% dev. from optimal &22.61\% &23.11\% &22.07\% &23.10\% &23.00\% \\[-1pt] \tabucline[1pt]{1-6}
        BMQHOA Mean &7438487$\pm$29887.17 &10276681$\pm$50507.35 &7774520$\pm$34559.10 &9075476$\pm$53168.02 &9330322$\pm$46301.35 \\ \hline
        Mean \% dev. optimal &25.07\% &25.22\% &24.41\% &25.33\% &25.03\% \\[-1pt] \tabucline[1pt]{1-6}
    \end{tabu}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        Mean \% dev. from optimal &0\% &0.00\% &6.39\% &10.47\% &20.34\% \\[-1pt] \tabucline[1pt]{1-6}
        BMQHOA Mean &8974.5$\pm$147.24 &10976.50$\pm$154.37 &47401.50$\pm$841.75 &91725.83$\pm$1346.23 &431259.66$\pm$3049.43 \\ \hline
        Mean \% dev. from optimal &1.88\% &2.32\% &13.02\% &17.08\% &23.48\% \\[-1pt] \tabucline[1pt]{1-6}
    \end{tabu}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        Mean \% dev. from optimal &0\% &0.38\% &1.59\% &3.76\% &8.33\% \\[-1pt] \tabucline[1pt]{1-6}
        BMQHOA Mean &1508.16$\pm$6.82 &1613.66$\pm$16.74 &8435.33$\pm$60.60 &16539$\pm$133.95 &80900.66$\pm$970.71 \\ \hline
        Mean \% dev. from optimal &0.38\% &1.24\% &6.81\% &8.37\% &10.31\% \\[-1pt] \tabucline[1pt]{1-6}
    \end{tabu}
\end{table}
...
\begin{table}[h!]
    ...
    \begin{tabu}{|c|[1pt]c|c|c|c|c|c|}
        ...
        Mean \% dev. from optimal &0.22\% &0\% &4.91\% &8.55\% &13.93\% \\[-1pt] \tabucline[1pt]{1-6}
        BMQHOA Mean &2327.33$\pm$48.55 &2658.66$\pm$48.81 &13334.66$\pm$182.91 &25604$\pm$91.32 &123813.83$\pm$773.19 \\ \hline
        Mean \% dev. from optimal &2.90\% &1.42\% &7.33\% &11.46\% &15.72\% \\[-1pt] \tabucline[1pt]{1-6}
    \end{tabu}
\end{table}
